...
Shouts.getRichData = function(data, callback) {
	...
	switch(data.name) {
		case 'extension':
			richData.picture = data.picture;
			richData.type = data.type;
			richData.extension = true;
			break;
		case 'tournament':
			richData.picture = data.gamemode;
			richData.type = data.server;
			richData.tournament = true;
			break;

		case 'replay':
			richData.map = data.map;
			richData.version = data.version;
			richData.match = data.type;
			richData.replay = true;
			break;
	}
