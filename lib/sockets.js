...
Sockets.events = {
	...
	uploadActionModule: uploadActionModule,
	editActionModule: editActionModule,
...
function uploadActionModule(socket, data, callback) {
	Actions.uploadFile(data, null, callback);
}

function editActionModule(socket, data, callback) {
	Actions.edit(data, null, callback);
}

function createActionModule(socket, data, callback) {
	Actions.create(data, null, callback);
}
