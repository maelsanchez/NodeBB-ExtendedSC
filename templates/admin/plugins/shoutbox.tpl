<div class="row">
    <div class="col-lg-9">
        <form class="form extendedsc-settings">
            <div class="panel panel-default">
                <div class="panel-heading">ExtendedSC</div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" data-key="toggles.guestsAllowed" data-trim="false"> Allow read acextendedscs to guests
                                </label>
                            </div>
                            <div class="checkbox">
                                <label>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="features">
                        <!-- BEGIN features -->
                        <div data-feature="{features.id}" class="extendedsc-admin-feature">
                            <div class="checkbox">
                                <label>
    ...
    <div class="col-lg-3">
        <div class="panel panel-default">
            <div class="panel-heading">ExtendedSC control panel</div>
            <div class="panel-body">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <button type="button" class="btn btn-danger btn-block" id="extendedsc-remove-deleted-button">Remove deleted shouts</button>
                <button type="button" class="btn btn-danger btn-block" id="extendedsc-remove-all-button">Remove all shouts</button>
            </div>
        <div
    </div>
</div>